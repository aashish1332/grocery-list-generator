...
export function ShaderAnimation({ isLightMode }) {
  ...
  // Update uniform when isLightMode changes
  useEffect(() => {
    if (sceneRef.current.uniforms) {
      sceneRef.current.uniforms.lightMode.value = isLightMode ? 1.0 : 0.0
    }
  }, [isLightMode])
  ...
  const initThreeJS = () => {
    ...
    const uniforms = {
      ...
      lightMode: { type: "f", value: isLightMode ? 1.0 : 0.0 },
    }
